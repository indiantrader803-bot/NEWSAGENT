...
"""
html = re.sub(r'\s*</style>', ui_css_inject, html)

# Replace Header
html = re.sub(
    r'<h1 style="font-size: 1.4rem; font-weight: 700; margin: 0; color: var\(--text-color\); display: flex; align-items: center; gap: 10px;">',
